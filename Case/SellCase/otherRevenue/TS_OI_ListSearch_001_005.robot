...
*** Tasks ***
22ตรวจสอบการแสดงรายการ_โดยมีเงื่อนไขดังนี้_เลือก_Checkbox_ค้างชำระ_ระบุรายการที่มีสถานะ_ค้างชำระ_ในระบบ   automate@gmail.com   123123   OE Page Search   yes   yes   no       ชำระแล้ว        ค้างชำระ        บริษัท ดีแทค ไตรเน็ต จำกัด
